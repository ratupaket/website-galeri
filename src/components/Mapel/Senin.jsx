    ...
    return (
        <>
        	<div className="border-t-2 border-b-2 border-white flex justify-between py-[0.50rem] w-72 px-3" data-aos="fade-up" data-aos-duration="600">
					<div className="w-[50%] text-base  font-medium">Meet & Greet</div>
					<div className="flex justify-center items-center text-sm">Goes To 5TH</div>
				</div>
				<div className=" flex justify-between py-[0.50rem] w-72 px-3 opacity-60" data-aos="fade-up" data-aos-duration="600">
					<div className="w-[50%] text-base  font-medium">Sharing & Caring</div>
					<div className="flex justify-center items-center text-sm">Goes To 9TH</div>
				</div>
				<div className="border-t-2 border-b-2 border-white flex justify-between py-[0.50rem] w-72 px-3" data-aos="fade-up" data-aos-duration="700">
					<div className="w-[50%] text-base  font-medium">Family Gathering</div>
					<div className="flex justify-center items-center text-sm">Goes To 4TH</div>
				</div>
				<div className=" border-b-2 border-white flex justify-between py-[0.50rem] w-72 px-3" data-aos="fade-up" data-aos-duration="800">
					<div className="w-[50%] text-base  font-medium">Undian Anggota</div>
					<div className="flex justify-center items-center text-sm">Goes To 2TH</div>
				</div>

				<div className=" flex justify-between py-[0.50rem] w-72 px-3 opacity-60" data-aos="fade-up" data-aos-duration="900">
					<div className="w-[50%] text-base  font-medium">Pembagian</div>
					<div className="flex justify-center items-center text-sm">Goes To 9TH</div>
				</div>
        </>
    )
