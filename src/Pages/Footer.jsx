				...
				<div class="md:flex md:justify-between">
					...
					<div class="grid grid-cols-2 sm:grid-cols-3">
						...
						<div className="">
							...
							<ul class="text-gray-400 dark:text-gray-400 font-medium">
								<li class="mb-2">
									<a href="https://web.facebook.com/people/Ratu-Paket/pfbid02VFrFQvr66NMgnVXWZCf1NZPyKMLqRjVb7gr8DUbj6tsbpQnFCFazgqXqhvbodhkdl/?mibextid=ZbWKwL" class="hover:underline ">
										Facebook
									</a>
								</li>
								<li>
									<a href="https://www.tiktok.com/@ratupaket?_t=8dqFMTqECi0&_r=1" class="hover:underline">
										Tiktok
									</a>
								</li>
							</ul>
				...
				<div class="sm:flex sm:items-center sm:justify-between">
					<div class="flex mt-4 justify-center sm:mt-0">
						<p className="text-[0.7rem] text-white opacity-70">
							© {new Date().getFullYear()} Ratu Paket Lebaran
						</p>
					</div>
				</div>
			</div>
